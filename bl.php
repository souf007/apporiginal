    ...
    <div class="flex-grow-1">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4">Gestion des Bons de livraison</h2>
                <?php if (preg_match("#Ajouter Bons de livraison,#", $_SESSION['easybm_roles'])): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBlModal">
            ...
            <ul class="nav nav-tabs mb-4">
                ...
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link active" href="bl.php">Bons de livraison</a></li>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="keyword" placeholder="Réf bon de livraison, client...">
                        </div>
                        <div class="col-md-4">
            ...
            <div class="table-responsive">
                <div class="lx-table-bl">
                    <!-- BL table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Bons de livraison,#",$_SESSION['easybm_roles'])): ?>
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exportBlModal">
...
<!-- Add Bl Modal -->
<div class="modal fade" id="addBlModal" tabindex="-1" aria-labelledby="addBlModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addBlModalLabel">Ajouter un nouveau bon de livraison</h5>
...
<!-- Export Bl Modal -->
<div class="modal fade" id="exportBlModal" tabindex="-1" aria-labelledby="exportBlModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportBlModalLabel">Exporter les bons de livraison</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
