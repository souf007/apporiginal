<?php include("avoirs_logic.php"); ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="utf-8">
    <title>Factures Avoir</title>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/avoirs.css">
    ...
    <div class="flex-grow-1">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4">Gestion des Factures Avoir</h2>
                <?php if (preg_match("#Ajouter Factures avoir,#", $_SESSION['easybm_roles'])): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addAvoirModal">
                        <i class="fas fa-plus"></i> Nouvelle facture avoir
                    </button>
                <?php endif; ?>
            </div>
            ...
            <ul class="nav nav-tabs mb-4">
                ...
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link active" href="avoirs.php">Factures avoir</a></li>
                ...
                <?php endif; ?>
                 <?php if(preg_match("#Consulter Factures proforma#",$_SESSION['easybm_roles'])): ?>
                    <li class="nav-item"><a class="nav-link" href="facturesproforma.php">Factures proforma</a></li>
                <?php endif; ?>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="keyword" placeholder="Réf facture avoir, client...">
                        </div>
                        <div class="col-md-4">
            ...
            <div class="table-responsive">
                <div class="lx-table-avoirs">
                    <!-- Avoirs table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Factures avoir,#",$_SESSION['easybm_roles'])): ?>
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exportAvoirModal">
...
<!-- Add Avoir Modal -->
<div class="modal fade" id="addAvoirModal" tabindex="-1" aria-labelledby="addAvoirModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addAvoirModalLabel">Ajouter une nouvelle facture avoir</h5>
...
<!-- Export Avoir Modal -->
<div class="modal fade" id="exportAvoirModal" tabindex="-1" aria-labelledby="exportAvoirModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportAvoirModalLabel">Exporter les factures avoir</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
<!-- Custom JS -->
<script src="js/avoirs.js"></script>
