    ...
    <div class="flex-grow-1">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4">Gestion des Bons de sortie</h2>
                <?php if (preg_match("#Ajouter Bons de sortie,#", $_SESSION['easybm_roles'])): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBsModal">
                        <i class="fas fa-plus"></i> Nouveau bon de sortie
                    </button>
                <?php endif; ?>
            </div>
            ...
            <ul class="nav nav-tabs mb-4">
                ...
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link active" href="bs.php">Bons de sortie</a></li>
            </ul>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="keyword" placeholder="Réf bon de sortie, client...">
                        </div>
                        <div class="col-md-4">
            ...
            <div class="table-responsive">
                <div class="lx-table-bs">
                    <!-- BS table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Bons de sortie,#",$_SESSION['easybm_roles'])): ?>
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exportBsModal">
...
<!-- Add Bs Modal -->
<div class="modal fade" id="addBsModal" tabindex="-1" aria-labelledby="addBsModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addBsModalLabel">Ajouter un nouveau bon de sortie</h5>
...
<!-- Export Bs Modal -->
<div class="modal fade" id="exportBsModal" tabindex="-1" aria-labelledby="exportBsModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportBsModalLabel">Exporter les bons de sortie</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
