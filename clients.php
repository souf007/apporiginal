...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="clients.scss">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if (preg_match("#Ajouter Clients,#", $_SESSION['easybm_roles'])): ?>
                    <a href="#" class="btn btn-primary lx-open-popup" data-header="Ajouter un nouveau" data-table="clients" data-title="client">+ Nouveau client</a>
                <?php endif; ?>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row gx-3 gy-2 align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="clients.php" class="btn btn-outline-secondary"><i class="fas fa-sync-alt"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive mt-4">
                <div class="lx-table-clients">
                    <!-- Clients table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Clients,#",$_SESSION['easybm_roles'])): ?>
