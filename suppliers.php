<?php include("suppliers_logic.php"); ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="utf-8">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="suppliers.scss">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if (preg_match("#Ajouter Fournisseurs,#", $_SESSION['easybm_roles'])): ?>
                    <a href="#" class="btn btn-primary lx-open-popup" data-header="Ajouter un nouveau" data-table="suppliers" data-title="supplier">+ Nouveau fournisseur</a>
                <?php endif; ?>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row gx-3 gy-2 align-items-center">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="keyword" placeholder="Rechercher par nom, code, ICE, téléphone...">
                        </div>
                        <div class="col-auto">
                            <a href="suppliers.php" class="btn btn-outline-secondary"><i class="fas fa-sync-alt"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive mt-4">
                <div class="lx-table-suppliers">
                    <!-- Suppliers table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Fournisseurs,#",$_SESSION['easybm_roles'])): ?>
