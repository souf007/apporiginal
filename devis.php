    ...
    <div class="flex-grow-1">
        ...
        <main class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4">Gestion des Devis</h2>
                <?php if (preg_match("#Ajouter Devis,#", $_SESSION['easybm_roles'])): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDevisModal">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="keyword" placeholder="Réf devis, client...">
                        </div>
                        <div class="col-md-4">
            ...
            <div class="table-responsive">
                <div class="lx-table-devis">
                    <!-- Devis table will be loaded here by JavaScript -->
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="lx-action-bulk">
                     <?php if(preg_match("#Exporter Devis,#",$_SESSION['easybm_roles'])): ?>
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exportDevisModal">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addDevisModalLabel">Ajouter un nouveau devis</h5>
...
<!-- Export Devis Modal -->
<div class="modal fade" id="exportDevisModal" tabindex="-1" aria-labelledby="exportDevisModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportDevisModalLabel">Exporter les devis</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
