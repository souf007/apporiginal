...
if (preg_match("#Consultation de la journée en cours seulement Factures proforma#", $_SESSION['easybm_roles'])) {
...
$back = $bdd->query("SELECT COUNT(*) AS nb FROM documents WHERE category='client' AND type='factureproforma' AND trash='1'");
$row = $back->fetch();
