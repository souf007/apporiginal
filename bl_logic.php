...
if (preg_match("#Consultation de la journée en cours seulement Bons de livraison#", $_SESSION['easybm_roles'])) {
...
$back = $bdd->query("SELECT COUNT(*) AS nb FROM documents WHERE category='client' AND type='bl' AND trash='1'");
$row = $back->fetch();
